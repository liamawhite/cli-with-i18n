...
// be found at  "github.com/liamawhite/cli-with-i18n/plugin/plugin.go"
...
func main() {
	...
	// implementing the interface defined at "github.com/liamawhite/cli-with-i18n/plugin/plugin.go"
	//
